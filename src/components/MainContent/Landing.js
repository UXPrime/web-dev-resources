  ...
  render(){
    return (
      <div className="landing">
        ...
        <img src="https://kurtpetrek.github.io/development-resources/images/html.svg" alt="HTML icon" className="landing__html" />
        <img src="https://kurtpetrek.github.io/development-resources/images/css.svg" alt="CSS icon" className="landing__css" />
        <img src="https://kurtpetrek.github.io/development-resources/images/js.svg" alt="JS icon" className="landing__js" />
        <img src="https://kurtpetrek.github.io/development-resources/images/php.svg" alt="PHP icon" className="landing__php" />
        <img src="https://kurtpetrek.github.io/development-resources/images/ruby.svg" alt="Ruby icon" className="landing__ruby" />
      </div>
    )
  }
}
